...
#[pyclass]
struct PreKeyBundle {
    state: libsignal_protocol_rust::PreKeyBundle
}

#[pymethods]
impl PreKeyBundle {
    #[new]
    fn new(registration_id: u32,
        device_id: u32,
        ...
        identity_key: IdentityKey) -> PyResult<Self> {
        ...
        Ok( PreKeyBundle { state: libsignal_protocol_rust::PreKeyBundle::new(
            registration_id,
            device_id,
            pre_key_id,
            pre_key,
